...
**Offline Login** allows you to Minecraft account to sign in offline. You won't be able to join servers unless their option for online-mode is set to false, as these accounts do not request a session token from Mojang's authentication servers.
